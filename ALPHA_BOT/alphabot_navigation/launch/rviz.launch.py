...
def generate_launch_description():
    ...
    # Process XACRO
    xacro_path = os.path.join(get_package_share_directory('alphabot_description'), 'urdf', 'alphabot.urdf.xacro')
    ...
    rviz = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', os.path.join(get_package_share_directory('alphabot_bringup'), 'config', 'entire_setup.rviz')]
    )
